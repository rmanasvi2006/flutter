      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Lists
            const Text('List of numbers:', style: TextStyle(fontWeight: FontWeight.bold)),
            Text(numbers.join(', ')),
            const SizedBox(height: 16),
            
            // Maps
            const Text('Person Map:', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            // Function with loop
            const Text('Even Numbers (1-10):', style: TextStyle(fontWeight: FontWeight.bold)),
            ...getEvenNumbers(10).map((e) => Text(e)).toList(),
            const SizedBox(height: 16),
            
            // For loop in widget building
            const Text('For Loop Example:', style: TextStyle(fontWeight: FontWeight.bold)),
            for (int i = 0; i < 3; i++)
              Padding(
            ...
            const SizedBox(height: 16),
            const Text('Conditional Rendering:', style: TextStyle(fontWeight: FontWeight.bold)),
            if (number > 30)
