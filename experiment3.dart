...
class Experiment3 extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Aspect Ratio: ${screenSize.aspectRatio.toStringAsFixed(2)}'),
                    const SizedBox(height: 8),
                    Text(
  ...
  Widget _buildVerticalLayout() {
    return Column(
      children: [
        _buildInfoCard('Mobile Layout', 'This is optimized for small screens.', Icons.phone_android),
        const SizedBox(height: 8),
        _buildInfoCard('Portrait Mode', 'Content stacks vertically.', Icons.screen_rotation),
      ],
    );
  }
  ...
  Widget _buildHorizontalLayout(double padding) {
    return Row(
      children: [
        Expanded(
          child: _buildInfoCard('Wide Screen', 'This is optimized for larger screens.', Icons.laptop),
        ),
        SizedBox(width: padding),
        Expanded(
          child: _buildInfoCard('Landscape Mode', 'Content displays side by side.', Icons.screen_rotation),
        ),
      ],
    );
  }
